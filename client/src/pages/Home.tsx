          ...
          <section className="py-32 md:py-40 relative" data-testid="section-testimonials">
            ...
            <div className="max-w-6xl mx-auto px-8 lg:px-12 relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
                ...
                />
                <TestimonialCard 
                  quote="Talking to someone who truly understands, without judging me, made all the difference."
                  author="Karan"
                  age={30}
                />
                <TestimonialCard 
                  quote="Every conversation felt comforting — the people here are genuinely kind and supportive."
                  author="Aarav"
                  age={27}
                />
                <TestimonialCard 
                  quote="Opening up felt so much easier knowing I could stay anonymous the whole time."
                  author="Anusha"
                  age={29}
                />
              </div>
